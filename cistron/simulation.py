"""
Dual-paradigm simulation engine for CISTRON.
...
if TYPE_CHECKING:
    from cistron.compartments import SpatialCompartmentModel
    from cistron.dogma import CentralDogmaEngine
    from cistron.plugins import PluginRegistry
...
class BooleanSimulator:
    ...
    Update rule for node *v* with configured :class:`~cistron.topology.NodeLogic`:
