"""
Pathway & network graph renderer for CISTRON Phase 9.

Builds interactive SVG / HTML views of a :class:`~cistron.topology.SignalingNetwork`
...
def build_network_view(
    ...
    *,
    ...
    from cistron.components import EntityType
...
def render_network_html(model: NetworkViewModel, *, title: str = "CISTRON Network") -> str:
