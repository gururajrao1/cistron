"""
Air-gapped / vendored pathway assets for VOIDSIGNAL.
...
from voidsignal.knowledge_graph import KEGGClient, PathwayMap, pathway_map_to_network
...
class VendoredPathwayRepository:
    ...
    2. Packaged file under ``voidsignal/assets/pathways/``
...
<pathway name="path:hsa04010" org="hsa" number="04010"
         title="MAPK signaling pathway (VOIDSIGNAL embedded)">
