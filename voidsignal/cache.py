"""
Persistent local HTTP response cache for VOIDSIGNAL Phase 2.
...
_DEFAULT_DB_NAME = "voidsignal_http_cache.sqlite3"
...
def default_cache_path() -> Path:
    ...
    return Path(".voidsignal_cache") / _DEFAULT_DB_NAME
