"""
Automated scientific report & hypothesis generator for VOIDSIGNAL Phase 10.
...
class ReportContext:
    ...
    result: Any
    network: Any = None
    title: str = "VOIDSIGNAL Autonomous Research Brief"
...
class ScientificReportGenerator:
    ...
    def _abstract(self, plan: Any, result: Any) -> str:
        ...
        from voidsignal.ui.translator import translate_metric
        ...
        return "\n".join(
            [
                "## Abstract",
                "",
                f"We tasked an autonomous VOIDSIGNAL agent with the objective: "
                f"*\"{goal.text}\"*. "
