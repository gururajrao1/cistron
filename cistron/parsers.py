"""
Bioinformatics file parsers for CISTRON Phase 2.
...
:class:`~cistron.perturbation.Mutation` instances derived from variant
consequences.
"""
...
from cistron.perturbation import Mutation, MutationKind
...
def variants_to_mutations(
    ...
    *,
    ...
    """
    Map parsed VCF records onto Phase 1 :class:`~cistron.perturbation.Mutation`
...
def link_sequence_lengths(
    ...
    *,
    ...
    :class:`~cistron.components.Protein.sequence_length`.
    """
