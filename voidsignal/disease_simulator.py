"""
Systemic disease dysregulation controllers for VOIDSIGNAL Phase 7.

Extends Phase-4 :mod:`voidsignal.disease_models` with multi-pathway programmes:
...
from voidsignal.perturbation import Mutation, MutationKind, Perturbation, PerturbationManager
...
class DiseaseSimulator:
    ...
    def run(
        ...
        from voidsignal.simulation import SimulationConfig
