"""
Central-dogma process engine for CISTRON Phase 3.
...
Coupling
--------
:class:`CentralDogmaEngine` attaches to :class:`~cistron.simulation.MassActionRHS`.
...
from cistron.components import EntityType, Gene, Protein, RNA
