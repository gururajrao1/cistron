...
from voidsignal.cache import ResponseCache, default_cache_path, make_cache_key

PathLike = Union[str, Path]


def default_integration_cache_dir() -> Path:
    """Prefer ``.cache/voidsignal/db``; fall back beside the HTTP SQLite cache."""
    preferred = Path(".cache") / "voidsignal" / "db"
    try:
