...
from voidsignal.data.omnipath import OmniPathClient, tau_for_mechanism
...
from voidsignal.integrations.catalog import resolve_pathway_ids
...
def resolve_multisource_network(
    ...
    *,
    ...
    """Delegate to the async multi-source aggregator in ``voidsignal.data.resolver``."""
    from voidsignal.data.resolver import resolve_multisource_network as _resolve
...
def list_source_situations(
    ...
    from voidsignal.integrations.catalog import HUMAN_PATHWAY_CATALOG
            ...
            rows.append(
                {
                    ...
                    "query": tip["query"],
                    "pathway_id": "",
                    "description": "Curated VoidSignal condition",
                }
            )
