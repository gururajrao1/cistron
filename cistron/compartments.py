"""
Spatial compartment barriers and diffusion routing for CISTRON Phase 3.

Partitions a :class:`~cistron.topology.SignalingNetwork` into geographic
tiers and enforces barrier policies: edges that cross structural boundaries
must route through :class:`~cistron.components.Receptor` or transporter
