"""
Trajectory & pharmacology plotters for VOIDSIGNAL Phase 9.
...
from voidsignal.hpc_runner import ConfidenceBand, EnsembleResult
from voidsignal.pharmacology import DoseResponseCurve
...
def is_headless() -> bool:
    ...
    if os.environ.get("VOIDSIGNAL_HEADLESS", "").lower() in {"1", "true", "yes"}:
        return True
