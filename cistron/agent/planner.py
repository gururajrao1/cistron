"""
Autonomous experiment planner for CISTRON Phase 10.
...
from cistron.agent.literature_reasoner import LiteratureAlignmentReport, LiteratureReasoner
...
from cistron.hpc_runner import EnsembleResult, EnsembleRunner
...
from cistron.predictive_models import TargetDiscoveryModel, TargetScore
from cistron.simulation import DualEngineSimulator, SimulationConfig, TrajectoryResult
from cistron.statistics import TrajectoryComparison, compare_trajectories
    ...
    *,
    ...
    if llm is not None:
        try:
            ...
            reply = llm.complete(prompt, system="You refine CISTRON research goals.")
