"""
Parallel ensemble & Monte Carlo simulation for VOIDSIGNAL Phase 8.

:class:`EnsembleRunner` executes many :class:`~voidsignal.simulation.DualEngineSimulator`
...
def _config_from_dict(d: Mapping[str, Any]) -> SimulationConfig:
    from voidsignal.simulation import ODEStepper
