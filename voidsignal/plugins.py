"""
Modular plugin extension hub for VOIDSIGNAL Phase 6.
...
:class:`~voidsignal.simulation.DualEngineSimulator` timelines without editing
core modules.
"""
...
class BasePlugin(ABC):
    ...
    :class:`~voidsignal.simulation.PerturbationHook` from :meth:`step_hook`
...
class PluginRegistry:
    ...
    ENTRY_POINT_GROUP = "voidsignal.plugins"
    ...
    def discover_entry_points(self, *, group: Optional[str] = None) -> List[str]:
        """
        Load plugins advertised under ``voidsignal.plugins`` entry points.
