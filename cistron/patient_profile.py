"""
Patient-specific pathway synthesizer for CISTRON Phase 7.

Ingests multi-variant VCF streams and quantitative expression panels (RNA-seq
style scaling), maps them onto a baseline :class:`~cistron.topology.SignalingNetwork`,
...
from cistron.components import BiologicalEntity, KineticParameters, Protein
from cistron.parsers import (
    VCFParser,
    VariantRecord,
    variants_to_mutations,
)
from cistron.perturbation import Mutation, MutationKind, PerturbationManager
from cistron.simulation import DualEngineSimulator, PerturbationHook
