...
from cistron.omics.epigenomics import (
    EpigenomicProfile,
    EpigenomicTransformer,
    TranscriptionScale,
    make_demo_epigenomic_profile,
)
from cistron.omics.metabolomics import (
    FBAResult,
    MetabolicCoupler,
...
from cistron.omics.proteomics import (
    ProteinActivityState,
    PTMProfile,
    PTMTransformer,
    make_demo_ptm_profile,
)
from cistron.omics.splicing import (
...
def make_demo_multiomics_profile(sample_id: str = "OMICS_DEMO") -> MultiOmicsProfile:
    ...
    return MultiOmicsProfile(
        ...
        gene_aliases={},
        metadata={"source": "cistron.omics demo"},
    )
