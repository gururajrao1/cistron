"""
Structure-aware kinetic modulation for CISTRON Phase 3.
...
:class:`~cistron.simulation.MassActionRHS` (``vmax`` / ``k_cat``, ``km``,
``binding_affinity``).
...
from cistron.parsers import VariantConsequence, VariantRecord
