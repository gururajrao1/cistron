"""
Disease phenotyping engine for CISTRON Phase 4.

Warps a baseline :class:`~cistron.topology.SignalingNetwork` into concrete
pathological states that compile to :class:`~cistron.perturbation.Perturbation`
hooks for :class:`~cistron.simulation.DualEngineSimulator`.
