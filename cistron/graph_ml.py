"""
Graph serialization & tensor translation for CISTRON Phase 5.

Converts :class:`~cistron.topology.SignalingNetwork` snapshots and
:class:`~cistron.simulation.TrajectoryResult` dynamics into geometric-ML
ready tensors:
...
from cistron.components import BiologicalEntity, EntityType
from cistron.simulation import TrajectoryResult
from cistron.topology import InteractionEdge, InteractionType, SignalingNetwork
