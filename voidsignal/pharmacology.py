"""
Advanced pharmacodynamics engine for VOIDSIGNAL Phase 4.
...
* Explicit competitive / non-competitive / uncompetitive / allosteric
  ...
  consumed by :class:`~voidsignal.simulation.MassActionRHS`.
...
from voidsignal.perturbation import InhibitionModel, Perturbation, PerturbationManager, clamp01
