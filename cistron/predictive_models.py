"""
Target discovery & link-prediction engines for CISTRON Phase 5.

Blueprint Graph Attention (GAT) and Message-Passing (MPNN) encoders operate on
:class:`~cistron.graph_ml.GraphTensors` without requiring PyTorch. They score:
...
from cistron.graph_ml import GraphTensors
...
from cistron.toxicology import SafetyTarget, SafetyTargetPanel, ToxicologyMonitor, ToxicologyReport
